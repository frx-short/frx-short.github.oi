	    ...
	    if(attr == 'bnc') {
    		...
    		function mulshortgoo() {
    			if(countprocess < c) {
                    ...
                    xhr.open('GET', 'https://www.shareaholic.com/v2/share/shorten_link?apikey=8943b7fd64cd8b1770ff5affa9a9437b&service[name]=' + attr + '&url=' + b[countprocess]);
                    xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                    xhr.onload = function() {
                        var frxshort = JSON.parse(xhr.responseText);
                        if(frxshort.status_code == 200) {
